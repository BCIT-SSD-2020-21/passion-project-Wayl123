    ...
    <div>
      {
        ...
        :
          <span>
            ...
            <p className={nightText}>personC: No, knowing him he would not approve of this.</p>
            <p className={`${nightText} ${styles.inlineText}`}>personC: Well we can send it</p>
            <button className={`${nightText} ${styles.textButton}`} onClick={handleClick}>here.</button>
            <p className={nightText}>PersonB: I don't know... Are you sure this is fine?</p>
            <p className={nightText}>PersonC: Yeah it is fine.</p>
          </span>
      }
    </div>
  )
